...
const ManagerBillVerification = () => {
    ...
    const getStatusBadge = (status) => {
        const statusConfig = {
            ...
            'calculated': { bg: '#e0f2fe', color: '#075985', text: 'Calculated' },
            ...
            {viewMode === 'history' && (
                <div style={{
                    ...
                    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                        {['all', 'pending', 'calculated', 'manager_verified', 'approved', 'paid', 'rejected'].map(status => (
                            <button
                                key={status}
                                onClick={() => {
                                ...
                                <tr key={bill._id}>
                                    ...
                                    <td>
                                        <span className="amount-value">
                                            ₹{bill.totalAmount?.toLocaleString('en-IN', { maximumFractionDigits: 2 }) || '0.00'}
                                        </span>
                                    </td>
                                ...
                                <tfoot>
                                    <tr className="bill-total-row">
                                        ...
                                        <td className="bill-total-amount">
                                            ₹{selectedBill.totalAmount?.toLocaleString('en-IN', { maximumFractionDigits: 2 }) || '0.00'}
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
